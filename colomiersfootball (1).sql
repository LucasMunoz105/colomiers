...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 19 jan. 2026 à 22:57
...
(1, 'Nouveau site pour l\'US Colomiers', 'On a fait un nouveau site ! C\'est vachement plus joli dites-donc.', '', '0000-00-00 00:00:00', 1),
(29, 'Nouveau site pour l\'US GENIAL', 'On a fait un nouveau site ! C\'est vachement plus joli dites-donc.ezosgzoiergohiezgfez', '', NULL, 3);
...
(59, 'qbpeiuhgrli', 'bite ', 'phjnbbernvbferb'),
(61, 'khhu', 'uigguy', 'test');
...
(11, 'Une histoire', '1911 - 1924', '', 'ezazae');
...
(34, 'Zinédane', 'Zibobo', 'Attaquant', NULL);
...
--
ALTER TABLE `partenaire`
  MODIFY `id_partenaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
